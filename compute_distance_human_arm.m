...
%% it's for the simulation_robot_human.m script, the difference is in how the points of the human arm are computed

function [D,C1,C2,V1,V2,V3,V4,V5,V6] = compute_distance_human_arm(q,d,a,alpha,u_q,u_d,u_a,u_alpha)
...
P1_u = [A01_u(1,4), A01_u(2,4), A01_u(3,4)];
Q1_u = [A02_u(1,4), A02_u(2,4), A02_u(3,4)];

P2_u = [A02_u(1,4), A02_u(2,4), A02_u(3,4)];
Q2_u  = [A03_u(1,4), A03_u(2,4), A03_u(3,4)];

P3_u = [A03_u(1,4), A03_u(2,4), A03_u(3,4)];
